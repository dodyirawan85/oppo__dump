...
function oidtlogs() {
    ...
    mkdir -p sdcard/OppoStamp/trace_viewer
    cp -r /data/oppo/log/DCS/de/trace_viewer sdcard/OppoStamp/trace_viewer
    cp -r /data/oppo/log/DCS/en/trace_viewer sdcard/OppoStamp/trace_viewer
    #endif /* COLOROS_EDIT */
